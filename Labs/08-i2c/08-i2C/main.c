...
ISR(TIMER1_OVF_vect)
{
    ...
    // uint8_t humidityBase = 1;
    // uint8_t humidityDecimal = 1;
    // uint8_t temperatureBase = 1;
    // uint8_t temperatureDecimal = 1;
    // uint8_t checksum = 1;
     
    result = twi_start((0x5c<<1) + TWI_READ);
//     if (!result)
//     {
        // humidityBase = twi_read_ack();
        // humidityDecimal = twi_read_ack();
        // temperatureBase = twi_read_ack();
        // temperatureDecimal = twi_read_ack();
        // checksum = twi_read_nack();
        // twi_stop();
/*    }*/
     
    // itoa(humidityBase, uart_string, 10);
    // uart_puts("H: ");
    // uart_puts(uart_string);
    // uart_putc('.');
    // itoa(humidityDecimal, uart_string, 10);
    // uart_puts(uart_string);
    // uart_puts("\r\n");
    // itoa(temperatureBase, uart_string, 10);
    // uart_puts("T: ");
    // uart_puts(uart_string);
    // uart_putc('.');
    // itoa(temperatureDecimal, uart_string, 10);
    // uart_puts(uart_string);
    // uart_puts("\r\n");
    // itoa(checksum, uart_string, 10);
    // uart_puts("C: ");
    // uart_puts(uart_string);
    // uart_puts("\r\n");
    ...
    case STATE_ACK:
        ...
        uart_puts("Found device on address: ");
